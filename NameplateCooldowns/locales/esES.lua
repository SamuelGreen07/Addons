...
L["chat:addon-is-disabled"] = "Addon deshabilitado"
...
L["Disable test mode"] = "Desactivar Modo Test"
L["Enable test mode (need at least one visible nameplate)"] = "Modo test Activado (necesitas por lo menos una barra de vida visible)"
L["Filters"] = "Filtros"
L["filters.instance-types"] = "Asigna la visibilidad de los cooldowns en distintos tipos de entornos (grupo de mazmorra, grupo de raid, arena...)"
L["Font:"] = "Fuente"
L["General"] = "General"
...
L["options:general:disable-addon-btn"] = "Deshabilita el addon"
L["options:general:enable-addon-btn"] = "Habilita el addon"
L["options:general:enable-only-for-target-nameplate"] = "Mostrar los cooldowns sólamente en la barra de vida del objetivo."
--[[Translation missing --]]
...
L["options:profiles:open-profiles-dialog"] = "Abrir consola de perfiles"
