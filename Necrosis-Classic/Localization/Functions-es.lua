...
-- Traduction du nom des procs utilis�s par Necrosis
Necrosis.Translation.Proc = {
	["Backlash"] = "Contragolpe",
	["ShadowTrance"] = "Trance de las Sombras"
}

-- Traduction des noms des d�mons invocables
...
-- Traduction du nom des objets utilis�s par Necrosis
...
-- Gestion de la d�tection des cibles prot�g�es contre la peur
Necrosis.AntiFear = {
