...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20240810213051")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20240807020550" to be auto set by packager
