...
L["CONFIRMQUEUECLEARDESC"] = "Для сброса очереди использовать Alt-левый-клик вместо левый-клик"
L["CONFIRMQUEUECLEARNAME"] = "Использовать Alt-клик для сброса очереди"
L["Copy"] = "Копировать"
...
L["DISPLAYSHOPPINGLISTATAUCTIONDESC"] = "Показывать на аукционе список предметов для крафта из вашей очереди, отсутствующих в ваших сумках"
L["DISPLAYSHOPPINGLISTATAUCTIONNAME"] = "Показывать список покупок на аукционе"
L["DISPLAYSHOPPINGLISTATBANKDESC"] = "Показывать в банке список предметов для крафта из вашей очереди, отсутствующих в ваших сумках"
