...
-- Text
	...
	["PulldownInstance"]		= {
		...
		-- WOTLK
		["upgardekeep"]			= {5, "Upgarde Keep", 68, 80, "UTK", {1, 1, 3}, { [ " utk "]=1, [" uk "]=1 }, nil, "WOTLK Normal"},
		["thenexus"]			= {5, "The Nexus", 69, 80, "nexus", {1, 1, 3}, { [" nexus "]=1, [" nex "]=1 }, nil, "WOTLK Normal"},
		["azjolnerub"]			= {5, "Azjol-Nerub", 70, 80, "azn", {1, 1, 3}, { [" azn "]=1, [" an "]=1  }, nil, "WOTLK Normal"},
				-- not complete
		["ahnkahet"]			= {5, "Ahn'kahet: The Old Kingdom", 73, 80, "ank", {1, 1, 3}, { [" ank "]=1, [" old "]=1, [" ako "]=1, [" ank "]=1, [" ok "]=1 }, nil, "WOTLK Normal"},
		["draktharan"]			= {5, "Drak'Tharon Keep", 74, 80, "dtk", {1, 1, 3}, { [" dtk "]=1 }, nil, "WOTLK Normal"},
		["theviolethold"]		= {5, "The Violet Hold", 75, 80, "vh", {1, 1, 3}, { [" vh "]=1 }, nil, "WOTLK Normal"},
	...
	["PulldownRaids"]			= {
		...
		--WOTLK
		["naxxramas"]			= { 25, "Naxxramas", 80, 80, "Naxx", {3, 08, 14}, { [" naxx"]=1 }, nil, "WOTLK"},
		["obsidiansanctum"]		= { 25, "Obsidian Sanctum", 80, 80, "Sarth", {3, 08, 14}, { [" sarth"]=1, [" os "]=1 }, nil, "WOTLK"},
		["vaultofarchavon"]		= { 25, "Vault of Archavon", 80, 80, "VoA", {3, 08, 14}, { [" vault"]=1, [" voa"]=1 }, nil, "WOTLK"},
		["eyeofeternity"]		= { 25, "Eye of Eternity", 80, 80, "EoE", {3, 08, 14}, { [" eoe"]=1, [" maly"]=1  }, nil, "WOTLK"},
		["ulduar"]				= { 25, "Ulduar", 80, 80, "Uld", {3, 08, 14}, { [" uld"]=1 }, nil, "WOTLK"},
		["trialofthecrusader"]	= { 25, "Trial of the Crusader", 80, 80, "ToC", {3, 08, 14}, { [" tc "]=1, [" toc "]=1, [" totc"]=1, [" togc"]=1 }, nil, "WOTLK"},
		["onyxiaslair"]			= { 25, "Onyxia's Lair", 80, 80, "Ony", {3, 08, 14}, { [" ony"]=1 }, nil, "WOTLK"},
		["icecrowncitadel"]		= { 25, "Icecrown Citadel", 80, 80, "ICC", {3, 08, 14}, { [" icc"]=1  }, nil, "WOTLK"},
		["rubysanctum"]			= { 25, "Ruby Sanctum", 80, 80, "RS", {3, 08, 14}, { [" rs"]=1, [" hal"]=1 }, nil, "WOTLK"},
	},
