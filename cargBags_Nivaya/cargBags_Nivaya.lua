...
function cbNivaya:OnBankOpened() 
	...
	if isRetail then
		...
		cbNivaya:ShowBags(cB_Bags.bankSets, cB_Bags.bankArmor, cB_Bags.bankGem, cB_Bags.bankQuest, cB_Bags.bankTrade, cB_Bags.bankConsumables, cB_Bags.bankArtifactPower, cB_Bags.bankBattlePet) 
	end
	if cBniv.BankCustomBags then
...
function cbNivaya:OnBankClosed()
	if isRetail then
		...
		cbNivaya:HideBags(cB_Bags.bank, cB_Bags.bankSets, cB_Bags.bankArmor, cB_Bags.bankGem, cB_Bags.bankQuest, cB_Bags.bankTrade, cB_Bags.bankConsumables, cB_Bags.bankArtifactPower, cB_Bags.bankBattlePet)
	end
	if cBniv.BankCustomBags then
...
function cbNivaya:CatDropDownInit()
	...
	AddInfoItem("-------------")
	AddInfoItem("Armor")
	if isRetail then AddInfoItem("BattlePet") end
	AddInfoItem("Consumables")
	AddInfoItem("Quest")
	AddInfoItem("TradeGoods")
	AddInfoItem("Gem")
	if isRetail and ns.options.filterArtifactPower then AddInfoItem("ArtifactPower") end
	AddInfoItem("Stuff")
	AddInfoItem("Junk")
	AddInfoItem("Bag")
	for _,v in ipairs(cB_CustomBags) do
