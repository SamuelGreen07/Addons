...
LSM:Register(MediaType_FONT, "Ubuntu",                      [[Interface\Addons\SharedMedia\fonts\ubuntu\Ubuntu-R.ttf]],                                 ruRU + western)
LSM:Register(MediaType_FONT, "Ubuntu Mono",                 [[Interface\Addons\SharedMedia\fonts\ubuntu\UbuntuMono-R.ttf]],                             ruRU + western)
LSM:Register(MediaType_FONT, "Fira",                        [[Interface\Addons\SharedMedia\fonts\fira\FiraSans-R.ttf]],                                 ruRU + western)
