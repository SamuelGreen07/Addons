...
L["DISPLAYREQUIREDLEVELNAME"] = "필요한 레벨 표시"
...
L["Enabled"] = "가능"
L["Enchant"] = "마법부여"
L["ENHANCHEDRECIPEDISPLAYDESC"] = "사용하면, 제조법 이름에 난이도를 나타내는 '+' 문자가 하나 이상 붙습니다."
L["ENHANCHEDRECIPEDISPLAYNAME"] = "제조법 난이도 문자로 표시"
L["Expand all groups"] = "모든 그룹 펼침"
L["Features"] = "기능"
L["FEATURESDESC"] = "Skillet 기능 설정"
L["Filter"] = "필터"
L["Flush All Data"] = "모든 데이터 삭제"
L["Flush Recipe Data"] = "제조법 데이터 삭제"
L["FLUSHALLDATADESC"] = "모든 Skillet 데이터를 삭제합니다."
L["FLUSHRECIPEDATADESC"] = "Skillet 제조법 데이터를 삭제합니다."
--Translation missing 
