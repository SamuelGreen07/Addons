		...
		map_options = {
			...
			args = {
				...
				scale = {
					...
					width = "full",
					disabled = function() return (not RSConfigDB.IsShowingNpcs() and not RSConfigDB.IsShowingContainers()) end,
				},
				minimapscale = {
					order = 3,
					type = "range",
					...
					width = "full",
					disabled = function() return (not RSConfigDB.IsShowingMinimapIcons() or (not RSConfigDB.IsShowingNpcs() and not RSConfigDB.IsShowingContainers())) end,
				},
				icons = {
					type = "group",
					order = 1,
					...
					args = {
						...
						displayOldNotDiscoveredMapIcons = {
							...
							width = "full",
							disabled = function() return (not RSConfigDB.IsShowingNpcs() and not RSConfigDB.IsShowingContainers()) or (not RSConfigDB.IsShowingNotDiscoveredNpcs() and not RSConfigDB.IsShowingNotDiscoveredContainers() and not RSConfigDB.IsShowingNotDiscoveredEvents()) end,
						},
					},
				},
				timers = {
